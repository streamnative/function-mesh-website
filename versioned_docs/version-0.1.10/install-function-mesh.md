...
```shell
curl -sSL https://github.com/streamnative/function-mesh/releases/download/v0.1.10/install.sh | bash
```
...
2. Create the custom resource type.
    ...
    ```shell
    curl -sSL https://github.com/streamnative/function-mesh/releases/download/v0.1.10/crd.yaml | kubectl create -f -
    ```

...
| `cleanupImage` | The image that is used to delete the subscriptions created or used by a sink when the sink is deleted. If no clean-up image is set, the runner image will be used. |
